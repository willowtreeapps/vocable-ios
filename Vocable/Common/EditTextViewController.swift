...
final class EditTextViewController: UIViewController, UICollectionViewDelegate {
    ...
    private var keyboardViewController: KeyboardViewController? {
        didSet {
            keyboardViewController?.displayText = initialText
        }
    }
    
    @IBOutlet var textView: OutputTextView! {
        didSet {
            textView.attributedText = keyboardViewController?.attrText
        }
    }
    ...
    override func viewDidLoad() {
        ...
        keyboardViewController?.$attrText.sink(receiveValue: { (attributedText) in
