...
class PaginationCollectionViewCell: VocableCollectionViewCell {
    ...
    private func updatePaginationLabel() {
        ...
        attributedString.addAttributes([.font: UIFont.boldSystemFont(ofSize: fontSize), .foregroundColor: isEnabled ? UIColor.defaultTextColor : UIColor.defaultTextColor.disabled(blending: borderedView.backgroundColor)],
