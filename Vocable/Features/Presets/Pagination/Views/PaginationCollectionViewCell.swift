...
class PaginationCollectionViewCell: VocableCollectionViewCell {
    ...
    private func updatePaginationLabel() {
        ...
        attributedString.addAttributes([.font: UIFont.boldSystemFont(ofSize: fontSize), .foregroundColor: isEnabled ? UIColor.defaultTextColor : UIColor.defaultTextColor.blended(with: borderedView.backgroundColor!, amount: 0.8)],
