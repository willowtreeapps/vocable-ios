...
class EditSayingsViewController: UIViewController, UICollectionViewDelegate, NSFetchedResultsControllerDelegate {

    @IBOutlet private var titleLabel: UILabel!

    @IBOutlet private var addButton: GazeableButton!
    @IBOutlet private var backButton: GazeableButton!
    @IBOutlet private var collectionView: CarouselGridCollectionView!
